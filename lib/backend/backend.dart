...
import 'schema/coment_record.dart';
...
export 'schema/coment_record.dart';
...
/// Functions to query ComentRecords (as a Stream and as a Future).
Future<int> queryComentRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ComentRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ComentRecord>> queryComentRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ComentRecord.collection,
      ComentRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ComentRecord>> queryComentRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
