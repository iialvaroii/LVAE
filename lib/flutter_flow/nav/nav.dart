      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'LVAE') : const LvaeWidget(),
        ),
        FFRoute(
          name: 'Donacion',
          path: '/donacion',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Donacion')
              : const DonacionWidget(),
        ),
        FFRoute(
          name: 'Posts',
          path: '/posts',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'Posts') : const PostsWidget(),
        ),
        FFRoute(
          name: 'comentarios',
          path: '/comentarios',
        ...
        FFRoute(
          name: 'crete_post',
          path: '/cretePost',
          builder: (context, params) => const CretePostWidget(),
        ),
        FFRoute(
          name: 'recoverPass',
          path: '/recoverPass',
          builder: (context, params) => const RecoverPassWidget(),
        ),
        FFRoute(
          name: 'settings',
          path: '/settings',
        ...
        FFRoute(
          name: 'RegistroLVAE',
          path: '/registroLVAE',
          builder: (context, params) => const RegistroLVAEWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'chat_intermedio',
          path: '/chatIntermedio',
          builder: (context, params) => ChatIntermedioWidget(
            otrous: params.getParam('otrous', ParamType.String),
          ),
        )
